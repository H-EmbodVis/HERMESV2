...
def args_parser():
    ...
    parser.add_argument(
        "--keep-meta",
        action="store_true",
        help="Keep the original 'meta' field in the checkpoint. By default meta is removed.",
    )
...
def main():
    ...
    # By default we remove meta to avoid leaking environment-specific info.
    # Use --keep-meta to preserve it.
    meta = copy.deepcopy(checkpoint['meta']) if (args.keep_meta and 'meta' in checkpoint) else {}
