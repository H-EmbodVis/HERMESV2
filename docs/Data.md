...
- Create a `ckpt` directory in your project root, and download the following model weights into it:
  ...
  - [hermes++.stage1.pth](https://huggingface.co/H-EmbodVis/HERMESV2/blob/main/ckpt/hermes%2B%2B.stage1.pth)
  - [hermes++.stage2.1.pth](https://huggingface.co/H-EmbodVis/HERMESV2/blob/main/ckpt/hermes%2B%2B.stage2.1.pth)
  - [hermes++.stage2.2.pth](https://huggingface.co/H-EmbodVis/HERMESV2/blob/main/ckpt/hermes%2B%2B.stage2.2.pth)
  - [hermes++.stage3.pth](https://huggingface.co/H-EmbodVis/HERMESV2/blob/main/ckpt/hermes%2B%2B.stage3.pth)
