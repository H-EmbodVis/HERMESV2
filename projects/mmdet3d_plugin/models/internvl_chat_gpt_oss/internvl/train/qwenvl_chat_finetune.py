...
from transformers import (
    AutoConfig, AutoModelForCausalLM, AutoTokenizer, AutoModelForImageTextToText,
...
class HERMESQwenVL(nn.Module):
    ...
    def __init__(
        ...
        if self.template_name == 'internvl2_5' or self.template_name == 'hermes_llm':
    ...
    def create_llm(self):
        ...
        # delete visual encoder to save memory
        del self.model._modules["model"].visual
    ...
    def chat(self, tokenizer, pixel_values, question, conv=None, generation_config=None, history=None,
             ...
             IMG_CONTEXT_TOKEN='<|vision_pad|>', IMG_START_TOKEN='<|vision_start|>', IMG_END_TOKEN='<|vision_end|>',
             verbose=False):
