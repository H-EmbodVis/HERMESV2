...
data = dict(
    ...
    train=dict(
        ...
        ego_mask=(-0.8, -1.5, 0.8, 2.5),
        data_root=data_root,
        ann_file=data_root + "nuscenes_advanced_12Hz_infos_train_unipad.pkl",
    ...
    val=dict(
        ...
        classes=class_names,
        modality=input_modality,
        ann_file="data/nuscenes/nuscenes_unified_infos_val.pkl",
        load_interval=1,
...
load_from = "/data/project/HERMES++/work-dir/hermes++/stage1/bev180-second-lidarinput-only-no-ego-point/stage1_second_only/20250824-1726/latest.pth"
resume_from = None
