...
lidar_sweep_num = 10
fp16_enabled = True
OPENAI_CLIP_MEAN = [0.48145466 * 255, 0.4578275 * 255, 0.40821073 * 255]
OPENAI_CLIP_STD = [0.26862954 * 255, 0.26130258 * 255, 0.27577711 * 255]
...
pts_voxel_size = [102.4 / (bev_h_ * 8), 102.4 / (bev_w_ * 8), 8 / (voxel_z_ * 8)]
point_nsample = 4096
unified_voxel_shape = [
...
model = dict(
    ...
    pts_middle_encoder=dict(
        ...
        in_channels=5,
        sparse_shape=[int((point_cloud_range[5] - point_cloud_range[2]) / pts_voxel_size[2]) + 1,
                      int((point_cloud_range[3] - point_cloud_range[0]) / pts_voxel_size[0]),
    ...
    pts_bbox_head=dict(
        ...
        llm_cfg=dict(llm_path='./projects/mmdet3d_plugin/models/internvl_chat/pretrained/InternVL2-2B',
                     ...
                     # Paper naming. Legacy `ego_attn_v2_*` keys are still supported in code.
                     curr2future_link_cfg=dict(
                         num_layers=6,
                         num_heads=16,
                         text_pool_k=1,
                         text_dim=2048,
                         ...
                         use_canbus_adaln=True,
                     )
                     ),
        use_can_bus=True,
        lidar_second_alignment=True,
        enable_gram_global_loss=True,
...
# load_from = '/data/project/HERMES++/work-dir/hermes++/stage2-2/bev180-second-align-cossim-noego/stage2-2++_second_align/20250827-1757/latest.pth'
load_from = '/data/project/HERMES++/work-dir/hermes++/stage2-2/bev180-second-align/stage2-2++_second_align/20250820-0551/latest.pth'
# pts_pretrained_path = "./work-dir/hermes++/stage1/bev180-second-lidarinput-only-no-ego-point/stage1_second_only/20250824-1726/latest.pth"
# pts_pretrained_path = "./work-dir/hermes++/stage1/bev180-second-lidarinput-only/stage1_second_only/20250817-0628/latest.pth"
resume_from = None
